...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents CalculateWaterIntakeLinkButton As System.Web.UI.WebControls.LinkButton
    Protected WithEvents WaterIntakeCalculationPanel As System.Web.UI.WebControls.Panel
    Protected WithEvents CalculateWaterButton As System.Web.UI.WebControls.Button
    Protected WithEvents IsActivePersonCheckBox As System.Web.UI.WebControls.CheckBox
    Protected WithEvents IsDryAreaCheckBox As System.Web.UI.WebControls.CheckBox
    Protected WithEvents WeightTextBox As System.Web.UI.WebControls.TextBox
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If m_goalDataSet.Tables("Goal").Rows.Count = 0 Then
            ...
            DataCommon.LoadRowValues(m_goalInfoRow, New String() {"UserAccountID", "WaterIntake", "SleepHours", "GoalPurposeID"}, New Object() {Me.GetUserAccountID, 75, 9, 2})
        Else
    ...
    Private Sub CalculateWaterIntakeLinkButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CalculateWaterIntakeLinkButton.Click
        WaterIntakeCalculationPanel.Visible = True
    End Sub

    Private Sub CalculateWaterButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CalculateWaterButton.Click
        db_WaterIntake.Text = CType(((CType(WeightTextBox.Text, Double) * CType(IIf(IsActivePersonCheckBox.Checked, 0.75, 0.5), Double)) _
            + CType(IIf(IsActivePersonCheckBox.Checked, 16, 0), Double) _
            + CType(IIf(IsDryAreaCheckBox.Checked, 16, 0), Double)), Integer).ToString
        db_WaterIntake.BackColor = Color.FromKnownColor(KnownColor.LightSeaGreen)
        WaterIntakeCalculationPanel.Visible = False
    End Sub
End Class
