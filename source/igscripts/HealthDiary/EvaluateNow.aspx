	...
	<body XMLNS:igchart="http://schemas.infragistics.com/ASPNET/WebControls/WebChart">
		<form id="Form1" method="post" runat="server">
			<TABLE valign="top" class="Dashed" id="Table1" borderColor="#009900" cellSpacing="0" borderColorDark="#006600"
				...
				<tr>
					<td>
						<asp:Image id="GoalStateImage" runat="server" Height="168px" ImageAlign="Left" Width="184px"></asp:Image>
						...
						<asp:Label id="goalWeeklyAverageHours" runat="server">Label</asp:Label><br>
						<br>
						<asp:Label id="Label3" runat="server">Your current hours/week is:</asp:Label>
						<asp:Label id="currentWeeklyAverageHours" runat="server">Label</asp:Label>
					</td>
				</tr>
				<tr>
					<td>
