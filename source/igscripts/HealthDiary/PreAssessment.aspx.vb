...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If m_pageDataSet.Tables(PageTableName).Rows.Count = 0 Then
            ...
            If Me.IsPostBack = False Then   'Setup default values
                DataCommon.LoadRowValues(m_pageDataInfoRow, New String() {"UserAccountID", "WaterIntake", "SleepHours"}, New Object() {Me.GetUserAccountID, 10, 9})
            End If
        Else
