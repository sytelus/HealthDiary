...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents RegisterErrorLabel As System.Web.UI.WebControls.Label
...
#End Region
    ...
    Private Sub CreateAccountButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CreateAccountButton.Click
        ...
        Dim userAccountData As DataSet = dataInstance.GetTableData("UserAccount", New String() {"LoginName"}, New Object() {UserNameTextBox.Text})
        If userAccountData.Tables("UserAccount").Rows.Count = 0 Then
