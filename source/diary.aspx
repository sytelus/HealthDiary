	...
	<body XMLNS:igtbl="http://schemas.infragistics.com/ASPNET/WebControls/UltraWebGrid">
		<form id="Form1" method="post" runat="server">
			...
			<TABLE class="Dashed" id="Table1" borderColor="#009900" cellSpacing="0" borderColorDark="#006600"
				cellPadding="10" align="center" borderColorLight="#009933" border="1" width="95%">
				<tr>
					<td>
					...
					<td>
						Need a help in planning? Check out <a href="activities.aspx">the extensive list of 
							what you can do!</a>
						<br>
						<br>
...
<BorderDetails ColorTop="White" WidthLeft="1px" WidthTop="1px" ColorLeft="White">
							...
							<Bands>
								<igtbl:UltraGridBand AddButtonCaption="Add one more line" ColFootersVisible="No" AllowUpdate="Yes" AllowAdd="Yes"
									AllowDelete="Yes">
									<Columns>
						...
						<asp:button id="SaveChangesButton" runat="server" Text="Save Changes" CssClass="FlatButton"
							ForeColor="red" Font-Bold="True" Width="344px"></asp:button><asp:rangevalidator id="RangeValidator1" runat="server" ErrorMessage="Value must be a number" Type="Integer"
